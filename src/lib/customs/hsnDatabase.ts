...
export const hsnDatabase: Record<string, HSNCode> = {
  ...
  '17049000': {
    ...
    globallyProhibited: false,
    globallyRestricted: false,
    commonNames: ['candy', 'sweets', 'confectionery']
  },
  '18063200': {
    code: '18063200',
    description: 'Chocolate in blocks, slabs or bars',
    category: 'Food',
    requiresLicense: false,
    globallyProhibited: false,
    globallyRestricted: false,
    commonNames: ['chocolate', 'chocolate bar']
  },
  ...
  '33049900': {
    ...
    globallyProhibited: false,
    globallyRestricted: false,
    commonNames: ['makeup', 'cosmetics', 'beauty product']
  },
  '33074900': {
    code: '33074900',
    description: 'Other perfumed preparations',
    category: 'Cosmetics',
    requiresLicense: false,
    globallyProhibited: false,
    globallyRestricted: true,
    restrictionReason: 'Contains alcohol - may be restricted in some countries',
    commonNames: ['perfume', 'fragrance', 'cologne']
  },
  ...
  '49019900': {
    ...
    globallyProhibited: false,
    globallyRestricted: false,
    commonNames: ['book', 'books', 'printed book']
  },
  '96081000': {
    code: '96081000',
    description: 'Ball point pens',
    ...
    globallyProhibited: false,
    globallyRestricted: false,
    commonNames: ['pen', 'ballpoint pen', 'writing pen']
  },
  ...
  '95030099': {
    ...
    globallyProhibited: false,
    globallyRestricted: false,
    commonNames: ['toy', 'toys', 'plaything']
  },
